...
class SectionManager {
    ...
    updateHobbiesSection(config) {
      ...
      if (titleElement) {
        titleElement.textContent = config.hobbies?.title || "Beyond Engineering";
      }
      ...
      const hobbies = config.hobbies?.items || [];
      ...
      hobbies.forEach((hobby) => {
        ...
        const alt = this.escapeHtml(hobby.alt || hobby.name || "Hobby image");
